package br.com.heiderlopes.notification
...
object NotificationUtils {
    ...
    fun notificationAutoReply(context: Context) {
        ...
        val notificationBuilder = NotificationCompat.Builder(context, CHANNEL_ID)
            .setSmallIcon(R.drawable.ic_logo_notification)
            .setContentTitle(context.getString(R.string.notif_title))
            .setContentTitle(context.getString(R.string.notif_text))
            .setPriority(NotificationCompat.PRIORITY_DEFAULT)
            .setColor(ActivityCompat.getColor(context, R.color.colorAccent))
            .setDefaults(Notification.DEFAULT_ALL)
            .addAction(action)
    ...
    private fun createNotificationUrgentChannel(context: Context) {
        val notificationManager =
            context.getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager
        val channel = NotificationChannel(
            URGENT_ID, context.getString(R.string.notif_channel_urgent_name),
